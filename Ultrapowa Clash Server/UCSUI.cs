...
namespace UCS
{
    public partial class UCSUI : MetroForm
    {
        ...
        private void UCSUI_Load(object sender, EventArgs e)
        {
            ...
            metroTextBox2.Text =""+ new WebClient().DownloadString("http://bot.whatismyipaddress.com/");
        ...
        {
            Process.Start("http://ultrapowa.com/forum");
        }
